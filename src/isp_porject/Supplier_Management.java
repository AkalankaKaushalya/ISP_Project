...
public class Supplier_Management extends javax.swing.JFrame {
    ...
    ResultSet rs = null;
    String role;
    public Supplier_Management(String value) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SUPPLIER DETAILS MANAGEMANT SYSTEM ");
        ...
        jLabel3.setText("Supplier Company :");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Supplier Address :");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Supplier Product :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String serarch = searchBar.getText();
            if(serarch.isEmpty())
            {
                JOptionPane.showMessageDialog(rootPane, "Enter Supplier Id And find");
            }
            else
            {
                try {
                String q = "SELECT * FROM `supplier` WHERE `id`=?";
                ...
                if (rs.next()) {
                    ...
                    String comapny = rs.getString("comapny");
                    String address = rs.getString("address");
                    String prudect = rs.getString("prudect");
                    String snumbe = rs.getString("snumbe");
                    String scode = rs.getString("scode");
                    String email = rs.getString("email");
                    String city = rs.getString("city");
                    jTextField2.setText(sname);
                    jTextField1.setText(comapny);
                    jTextArea1.setText(address);
                    jTextField3.setText(prudect);
                    jTextField4.setText(snumbe);
                    jTextField5.setText(scode);
                    jTextField6.setText(email);
                    jTextField7.setText(city);
                } else {
                    JOptionPane.showMessageDialog(null, "This Id Not Supplier", "Error", JOptionPane.ERROR_MESSAGE);
                }
                } catch (Exception e) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else
        {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Supplier deleted successfully", "Successfully", JOptionPane.INFORMATION_MESSAGE, icon);
                tableLode();
                clear();
            } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String comapny = jTextField1.getText();
        String address = jTextArea1.getText();
        String prudect = jTextField3.getText();
        String snumbe = jTextField4.getText();
        String scode = jTextField5.getText();
        ...
        {
            JOptionPane.showMessageDialog(rootPane, "City is empty");
        }
        else
        {
            try {
                String sql = "UPDATE `supplier` SET `sname` = ?, `comapny` = ?, `address` = ?, `prudect` = ?, `snumbe` = ?, `scode` = ?, `email` = ?, `city` = ? WHERE `id` = ?";
                pst = conn.prepareStatement(sql);
                pst.setString(1, sname);
                pst.setString(2, comapny);
                pst.setString(3, address);
                pst.setString(4, prudect);
                pst.setString(5, snumbe);
                pst.setString(6, scode);
                pst.setString(7, email);
                pst.setString(8, city);
                pst.setString(9, serarch);// replace customerId with the actual customer ID value
                pst.executeUpdate();
                ImageIcon icon = new ImageIcon("src/icon/ok.png");
                JOptionPane.showMessageDialog(null, "Supplier Update successfully", "Successfully", JOptionPane.INFORMATION_MESSAGE, icon);
                tableLode();
                clear();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(rootPane, e);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            try {
                String q = "INSERT INTO `supplier`(`sname`, `comapny`, `address`, `prudect`, `snumbe`, `scode`, `email`, `city`) VALUES ('" + sname + "','" + comapny + "','" + address + "','" + prudect + "','" + snumbe + "','" + scode + "','" + email + "','" + city + "')";
                pst = conn.prepareStatement(q);
                pst.execute();
                //JOptionPane.showMessageDialog(rootPane, "Member added successfully");
                ImageIcon icon = new ImageIcon("src/icon/ok.png");
                JOptionPane.showMessageDialog(null, "Supplier Add successfully", "Successfully", JOptionPane.INFORMATION_MESSAGE, icon);
                tableLode();
                clear();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(rootPane, e);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Supplier_Management smm = new Supplier_Management(value);
                smm.setVisible(true);
